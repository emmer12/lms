            ...
            >
                <path
                    ...
                    style="
                        ...
                        stroke-opacity: 1;
                    "
                    transform="translate(420.434 376.125)"
                    fill="none"
                    stroke="#fcad03"
                    stroke-width="15"
                    stroke-linecap="round"
                ...
                <path
                    ...
                    style="
                        ...
                        stroke-opacity: 1;
                    "
                    transform="translate(102.864 105.885)"
                    fill="none"
                    stroke="#fcad03"
                    stroke-width="15"
                    stroke-linecap="round"
                ...
                <path
                    ...
                    style="
                        ...
                        stroke-opacity: 1;
                    "
                    transform="translate(366.554 341.125)"
                    fill="none"
                    stroke="#fcad03"
                    stroke-width="15"
                    stroke-linecap="round"
                ...
                <path
                    ...
                    style="
                        ...
                        stroke-opacity: 1;
                    "
                    transform="translate(282.957 42.006)"
                    fill="none"
                    stroke="#fcad03"
                    stroke-width="15"
                    stroke-linecap="round"
                ...
                <path
                    ...
                    style="
                        ...
                        stroke-opacity: 1;
                    "
                    transform="translate(504.504 70.889)"
                    fill="none"
                    stroke="#fcad03"
                    stroke-width="15"
                    stroke-linecap="round"
                ...
                <path
                    ...
                    style="
                        ...
                        stroke-opacity: 1;
                    "
                    transform="translate(366.554 347.584)"
                    fill="none"
                    stroke="#fcad03"
                    stroke-width="15"
                    stroke-linecap="round"
                ...
                <path
                    ...
                    style="
                        ...
                        stroke-opacity: 1;
                    "
                    transform="translate(323.024 469.015)"
                    fill="none"
                    stroke="#fcad03"
                    stroke-width="15"
                    stroke-linecap="round"
                ...
                <path
                    ...
                    style="
                        ...
                        stroke-opacity: 1;
                    "
                    transform="translate(256.004 396.769)"
                    fill="none"
                    stroke="#fcad03"
                    stroke-width="15"
                    stroke-linecap="round"
                ...
                <path
                    ...
                    style="
                        ...
                        stroke-opacity: 1;
                    "
                    transform="translate(320.52 223.505)"
                    fill="none"
                    stroke="#fcad03"
                    stroke-width="15"
                    stroke-linecap="round"
                ...
                <path
                    ...
                    style="
                        ...
                        stroke-opacity: 1;
                    "
                    transform="translate(100.627 140.885)"
                    fill="none"
                    stroke="#fcad03"
                    stroke-width="15"
                    stroke-linecap="round"
                ...
                <path
                    ...
                    style="
                        ...
                        stroke-opacity: 1;
                    "
                    transform="translate(100.627 172.43)"
                    fill="none"
                    stroke="#fcad03"
                    stroke-width="15"
                    stroke-linecap="round"
