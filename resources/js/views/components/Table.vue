<template>
    ...
    >
        <table class="w-full divide-y divide-gray-200 table-auto">
            ...
            >
                <tr v-for="(record, i) in records" :key="i + 'record'">
                    <td
                    ...
                    >
                        <slot :item="record" :name="'content-' + j">
                            {{
                                record && record.hasOwnProperty(j)
                                    ? record[j]
                                    : ""
                            }}
                        </slot>
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                ...
                                <span
                                    v-if="
                                        !action.hasOwnProperty('showName') ||
                                        action.showName
                                    "
                                    v-html="action.name"
                                ></span>
...
export default defineComponent({
    ...
    setup(props, { emit }) {
        ...
        function getPaginationMeta(key) {
            ...
            if (props.pagination) {
                if (
                    props.pagination.hasOwnProperty("meta") &&
        ...
        function getActionClass(action) {
            ...
            if (action.hasOwnProperty("success") && action.success) {
