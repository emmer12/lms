    ...
    >
        ...
        >
            ...
            >
                ...
                <div
                    class="m-8 inline-block align-middle w-full max-w-2xl transform transition-all"
                >
                    <button
                        v-if="$props.showClose"
                        aria-label="close"
                        class="absolute z-10 bg-white rounded-full py-2 px-2 -top-5 -right-5 cursor-pointer focus:outline-none"
