...
class User extends Authenticatable implements MustVerifyEmail
{
    ...
    {
        return  DB::table('users')->pluck('title', 'id');
    }

    public function courses()
    {
        return $this->belongsToMany(Course::class, 'course_users')->withCount('lessons')->withPivot('progress', 'certificate_eligible');
    }

    public function lessons()
    {
        return $this->belongsToMany(Lesson::class, 'course_user_lessons')->withPivot('completed', 'course_id');
    }
}
